...
class QuickActions:
    ...
    def open_settings(self):
        ...
        try:
            # Try multiple methods to open Windows Settings
            # Method 1: Modern Windows Settings app
            try:
                ...
                try:
                    subprocess.Popen(
                        "powershell Start-Process ms-settings:", shell=True
                    )
                except:
                    # Method 3: Fallback to Control Panel
                    subprocess.Popen("control", shell=True)
        except Exception as e:
